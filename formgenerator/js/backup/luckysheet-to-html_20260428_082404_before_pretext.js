...
function escapeHtml(text) {
    ...
    // Normalize line breaks to a placeholder BEFORE HTML escaping, then emit <br>
    // after escaping. Mirrors luckysheet's own normalization (see vendor: \r\n,
    // &#13;&#10;, \r, \n → _x000D_) and additionally handles _x000D_ literals
    // that survive xlsx import. Placeholder uses NULs so it cannot collide with
    // user content or become a valid HTML token mid-escape.
    const NL = ' NL ';
    return String(text)
        .replace(/\r\n|\r|\n|_x000D_|&#13;&#10;|&#13;|&#10;/g, NL)
        .replace(/[&<>"']/g, m => map[m])
