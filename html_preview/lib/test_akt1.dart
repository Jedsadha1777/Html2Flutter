...
class _ContentWidgetState extends State<_ContentWidget> {
  ...
  // ============ CONTROLLERS ============
  final _textareaFieldAI3Controller = TextEditingController();
  final _textareaFieldJ8Controller = TextEditingController();
  final _inputFieldJ9Controller = TextEditingController();
  final _textareaFieldAD9Controller = TextEditingController();
  final _textareaFieldAD10Controller = TextEditingController();
  final _textareaFieldAD11Controller = TextEditingController();
  final _inputFieldAL16Controller = TextEditingController();
  final _inputFieldAL17Controller = TextEditingController();
  final _inputFieldAL18Controller = TextEditingController();
  final _inputFieldAL19Controller = TextEditingController();
  final _inputFieldAL20Controller = TextEditingController();
  final _inputFieldAL21Controller = TextEditingController();
  final _inputFieldAL22Controller = TextEditingController();
  final _inputFieldAL23Controller = TextEditingController();
  final _inputFieldAL24Controller = TextEditingController();
  final _inputFieldAL25Controller = TextEditingController();
  final _inputFieldAJ26Controller = TextEditingController();
  final _textareaFieldA28Controller = TextEditingController();
  final _textareaFieldA33Controller = TextEditingController();


  // ============ STATE VARIABLES ============
  bool _checkboxFieldAE16 = false;
  bool _checkboxFieldAE17 = false;
  bool _checkboxFieldAE18 = false;
  bool _checkboxFieldAE19 = false;
  bool _checkboxFieldAE20 = false;
  bool _checkboxFieldAE21 = false;
  bool _checkboxFieldAE22 = false;
  bool _checkboxFieldAE23 = false;
  bool _checkboxFieldAE24 = false;
  bool _checkboxFieldAE25 = false;
  ...
  builder: (context, constraints) {
    ...
    final matrixData = <List<int>>[
      ...
      <int>[270, 270, 270, 270, 270, 270, 270, 270, 270, 270, 270, 270, 282, 283, 284, 285, 286, 287, 288, 289, 290, 291, 292, 293, 294, 295, 296, 297, 297, 298, 299, 299, 301, 302, 302, 304, 304, 304, 304, 304, 304, 304, 304, 304],
      ...
      <int>[306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306],
      <int>[306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306],
      <int>[306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306],
      <int>[306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306, 306],
      <int>[307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307, 307],
      <int>[308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308],
      <int>[308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308],
      <int>[308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308],
      <int>[308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308],
      <int>[309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319, 320, 321, 322, 323, 324, 325, 326, 327, 328, 329, 330, 331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 342, 343, 344, 345, 346, 347, 348, 349, 350, 351, 352],
      <int>[353, 354, 355, 356, 356, 358, 358, 358, 358, 358, 358, 358, 358, 358, 358, 358, 358, 358, 359, 360, 361, 362, 363, 364, 365, 366, 367, 367, 369, 369, 369, 369, 369, 369, 369, 369, 369, 369, 369, 369, 369, 370, 371, 372],
      <int>[373, 374, 375, 376, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386, 387, 388, 389, 390, 391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413, 414, 415, 416],
      <int>[417, 418, 419, 420, 421, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 423, 424, 425, 426, 427, 428, 429, 430, 431, 432, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 434, 435, 436],
      <int>[437, 438, 439, 440, 441, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 442, 443, 444, 445, 446, 447, 448, 449, 450, 451, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 452, 453, 454],
      <int>[455, 456, 457, 458, 459, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 460, 461, 462, 463, 464, 465, 466, 467, 468, 469, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 470, 471, 472],
      <int>[473, 474, 475, 476, 477, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 422, 478, 479, 480, 481, 482, 483, 484, 485, 486, 487, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 433, 488, 489, 490],
      <int>[491, 492, 493, 494, 495, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 496, 519, 519, 519, 519, 519, 519, 519, 519, 519, 519, 519, 519, 519, 519, 519, 519],
      <int>[535, 536, 537, 538, 539, 540, 541, 542, 543, 544, 545, 546, 547, 548, 549, 550, 551, 552, 553, 554, 555, 556, 557, 558, 559, 560, 561, 562, 563, 564, 565, 566, 567, 568, 569, 570, 571, 572, 573, 574, 575, 576, 577, 578],
      <int>[579, 580, 581, 582, 583, 584, 585, 586, 587, 588, 589, 590, 591, 592, 593, 594, 595, 596, 597, 598, 599, 600, 601, 602, 603, 604, 605, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616, 617, 618, 619, 620, 621, 622],
    ];
      ...
      child: Stack(
        ...
        children: [
          ...
          cell(32, 2, 34, 3, bg: Color(0xFFFFFFFF), pad: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), child: DefaultTextStyle.merge(
                ...
                child: Text('No.', softWrap: false, overflow: TextOverflow.ellipsis),
              )),
          Positioned(left: cs[34], top: rs[2], width: cs[44] - cs[34], height: rs[3] - rs[2], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _textareaFieldAI3Controller, maxLines: 3, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[34], top: rs[3], width: cs[44] - cs[34], height: rs[4] - rs[3], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormDate(name: 'date-field-AI4'))),
          Positioned(left: cs[0], top: rs[4], width: cs[44] - cs[0], height: rs[7] - rs[4], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                ...
                child: Text('MACHINE INSPECTION REPORT', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          Positioned(left: cs[0], top: rs[7], width: cs[9] - cs[0], height: rs[8] - rs[7], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(left: BorderSide(color: Color(0xFF000000), width: 1), right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                ...
                child: Text('CUSTOMER NAME', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[9], top: rs[7], width: cs[44] - cs[9], height: rs[8] - rs[7], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _textareaFieldJ8Controller, maxLines: 3, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          Positioned(left: cs[0], top: rs[8], width: cs[9] - cs[0], height: rs[9] - rs[8], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(left: BorderSide(color: Color(0xFF000000), width: 1), right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('MACHINE MODEL', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[9], top: rs[8], width: cs[22] - cs[9], height: rs[9] - rs[8], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(bottom: BorderSide(color: Color(0xFF000000), width: 2), right: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldJ9Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          Positioned(left: cs[22], top: rs[8], width: cs[29] - cs[22], height: rs[9] - rs[8], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('SERIAL NUMBER', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[29], top: rs[8], width: cs[44] - cs[29], height: rs[9] - rs[8], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _textareaFieldAD9Controller, maxLines: 3, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          Positioned(left: cs[0], top: rs[9], width: cs[9] - cs[0], height: rs[10] - rs[9], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(left: BorderSide(color: Color(0xFF000000), width: 1), right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('DATE OF INSTALLATION', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[9], top: rs[9], width: cs[22] - cs[9], height: rs[10] - rs[9], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormDate(name: 'date-field-J10'))),
          Positioned(left: cs[22], top: rs[9], width: cs[29] - cs[22], height: rs[10] - rs[9], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('*******(Free)', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[29], top: rs[9], width: cs[44] - cs[29], height: rs[10] - rs[9], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 2))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _textareaFieldAD10Controller, maxLines: 3, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          Positioned(left: cs[0], top: rs[10], width: cs[9] - cs[0], height: rs[11] - rs[10], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('INSPECTION DATE', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[9], top: rs[10], width: cs[22] - cs[9], height: rs[11] - rs[10], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormDate(name: 'date-field-J11'))),
          Positioned(left: cs[22], top: rs[10], width: cs[29] - cs[22], height: rs[11] - rs[10], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('INSPECTOR BY', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[29], top: rs[10], width: cs[44] - cs[29], height: rs[11] - rs[10], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _textareaFieldAD11Controller, maxLines: 3, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[0], top: rs[12], width: cs[44] - cs[0], height: rs[13] - rs[12], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                ...
                child: Text('INSPECTION RESULT', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          Positioned(left: cs[0], top: rs[13], width: cs[2] - cs[0], height: rs[15] - rs[13], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                ...
                child: Text('ITEM', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          Positioned(left: cs[2], top: rs[13], width: cs[25] - cs[2], height: rs[15] - rs[13], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 18.6, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('INSPECTION ITEMS', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          ...
          Positioned(left: cs[30], top: rs[14], width: cs[37] - cs[30], height: rs[15] - rs[14], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 18.6, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('CHECKED', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          Positioned(left: cs[37], top: rs[14], width: cs[44] - cs[37], height: rs[15] - rs[14], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 18.6, fontWeight: FontWeight.bold, color: Color(0xFF000000)),
                child: Text('AFTER ADJUST', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          ...
          Positioned(left: cs[2], top: rs[15], width: cs[25] - cs[2], height: rs[16] - rs[15], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('RUN OUT ON SPINDLE(CHUCK) UNIT', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          ...
          Positioned(left: cs[30], top: rs[15], width: cs[37] - cs[30], height: rs[16] - rs[15], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE16'))),
          Positioned(left: cs[37], top: rs[15], width: cs[44] - cs[37], height: rs[16] - rs[15], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL16Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[30], top: rs[16], width: cs[37] - cs[30], height: rs[17] - rs[16], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE17'))),
          Positioned(left: cs[37], top: rs[16], width: cs[44] - cs[37], height: rs[17] - rs[16], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL17Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[30], top: rs[18], width: cs[37] - cs[30], height: rs[19] - rs[18], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE19'))),
          Positioned(left: cs[37], top: rs[18], width: cs[44] - cs[37], height: rs[19] - rs[18], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL19Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[30], top: rs[19], width: cs[37] - cs[30], height: rs[20] - rs[19], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE20'))),
          Positioned(left: cs[37], top: rs[19], width: cs[44] - cs[37], height: rs[20] - rs[19], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL20Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[30], top: rs[20], width: cs[37] - cs[30], height: rs[21] - rs[20], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE21'))),
          Positioned(left: cs[37], top: rs[20], width: cs[44] - cs[37], height: rs[21] - rs[20], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL21Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          Positioned(left: cs[0], top: rs[21], width: cs[2] - cs[0], height: rs[22] - rs[21], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(left: BorderSide(color: Color(0xFF000000), width: 1), right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('7', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          ...
          Positioned(left: cs[30], top: rs[21], width: cs[37] - cs[30], height: rs[22] - rs[21], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE22'))),
          Positioned(left: cs[37], top: rs[21], width: cs[44] - cs[37], height: rs[22] - rs[21], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL22Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[30], top: rs[22], width: cs[37] - cs[30], height: rs[23] - rs[22], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE23'))),
          Positioned(left: cs[37], top: rs[22], width: cs[44] - cs[37], height: rs[23] - rs[22], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL23Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[30], top: rs[23], width: cs[37] - cs[30], height: rs[24] - rs[23], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE24'))),
          Positioned(left: cs[37], top: rs[23], width: cs[44] - cs[37], height: rs[24] - rs[23], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL24Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[30], top: rs[24], width: cs[37] - cs[30], height: rs[25] - rs[24], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormCheckbox(name: 'checkbox-field-AE25'))),
          Positioned(left: cs[37], top: rs[24], width: cs[44] - cs[37], height: rs[25] - rs[24], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAL25Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          Positioned(left: cs[0], top: rs[25], width: cs[12] - cs[0], height: rs[26] - rs[25], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('INSPECTION RESULT', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          ...
          Positioned(left: cs[26], top: rs[25], width: cs[27] - cs[26], height: rs[26] - rs[25], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('0', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[27], top: rs[25], width: cs[29] - cs[27], height: rs[26] - rs[25], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('OK', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          ...
          Positioned(left: cs[30], top: rs[25], width: cs[32] - cs[30], height: rs[26] - rs[25], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.center, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('NG', softWrap: false, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
              ))),
          ...
          Positioned(left: cs[33], top: rs[25], width: cs[35] - cs[33], height: rs[26] - rs[25], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('Other', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[35], top: rs[25], width: cs[44] - cs[35], height: rs[26] - rs[25], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _inputFieldAJ26Controller, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          Positioned(left: cs[0], top: rs[26], width: cs[44] - cs[0], height: rs[27] - rs[26], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.topLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('INSPECTION HANDLING:', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[0], top: rs[27], width: cs[44] - cs[0], height: rs[31] - rs[27], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _textareaFieldA28Controller, maxLines: 3, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          Positioned(left: cs[0], top: rs[31], width: cs[44] - cs[0], height: rs[32] - rs[31], child: Container(
              decoration: BoxDecoration(color: Color(0xFFFFFFFF), border: Border(left: BorderSide(color: Color(0xFF000000), width: 1), right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.topLeft, child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('REMARK:', softWrap: false, overflow: TextOverflow.ellipsis),
              ))),
          Positioned(left: cs[0], top: rs[32], width: cs[44] - cs[0], height: rs[36] - rs[32], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(left: BorderSide(color: Color(0xFF000000), width: 1), right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: TextField(controller: _textareaFieldA33Controller, maxLines: 3, style: const TextStyle(fontFamily: 'Browallia New', fontSize: 16), decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8))))),
          ...
          Positioned(left: cs[5], top: rs[37], width: cs[18] - cs[5], height: rs[38] - rs[37], child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormDate(name: 'date-field-F38'))),
          ...
          Positioned(left: cs[28], top: rs[37], width: cs[41] - cs[28], height: rs[38] - rs[37], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormDate(name: 'date-field-AC38'))),
          ...
          Positioned(left: cs[5], top: rs[39], width: cs[18] - cs[5], height: rs[43] - rs[39], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormSignature(name: 'signature-field-F40'))),
          ...
          Positioned(left: cs[28], top: rs[39], width: cs[41] - cs[28], height: rs[43] - rs[39], child: Container(
              decoration: BoxDecoration(color: Colors.transparent, border: Border(right: BorderSide(color: Color(0xFF000000), width: 1), bottom: BorderSide(color: Color(0xFF000000), width: 1))),
              padding: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), alignment: Alignment.centerLeft, child: FormSignature(name: 'signature-field-AC40'))),
          ...
          cell(5, 43, 28, 44, bg: Color(0xFFFFFFFF), pad: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('ลายเซ็นลูกค้า Customers authorized signature', softWrap: false, overflow: TextOverflow.ellipsis),
              )),
          cell(28, 43, 44, 44, bg: Color(0xFFFFFFFF), pad: EdgeInsets.symmetric(vertical: 2.0, horizontal: 4.0), child: DefaultTextStyle.merge(
                style: TextStyle(fontFamily: 'Cordia New', fontSize: 21.3, color: Color(0xFF000000)),
                child: Text('ลายเซ็นวิศวกร Service Engineer signature', softWrap: false, overflow: TextOverflow.ellipsis),
              )),
