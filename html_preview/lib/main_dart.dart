...
void main() => runApp(PreviewShell(pages: _pages()));
...
Widget _page1() => UnconstrainedBox(
...
Widget _page2() => UnconstrainedBox(
  ...
  decoration: BoxDecoration(border: Border(top: BorderSide(color: Color(0xFFD7DAE0), width: 1), right: BorderSide(color: Color(0xFFD7DAE0), width: 1), bottom: BorderSide(color: Color(0xFFD7DAE0), width: 1), left: BorderSide(color: Color(0xFFD7DAE0), width: 1)), color: Color(0xFFFFFFFF)),
  child: LayoutBuilder(
  builder: (context, constraints) {
    final availableWidth = constraints.maxWidth;
      ...
      child: Stack(
        ...
        children: [
          ...
          cell(0, 2, 1, 3, pad: EdgeInsets.fromLTRB(4.0, 30.0, 4.0, 4.0), child: Column(
                ...
                overflow: TextOverflow.clip,
                text: TextSpan(
                  style: TextStyle(fontFamily: 'Browallia New', fontSize: 12.0),
                  children: [
                    TextSpan(text: 'MealShift Ltd', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF1A1C21))),
                    TextSpan(text: '1 Assam Street, London - E1 7QL'),
                    TextSpan(text: 'Registration number:12793366'),
                  ],
                ),
              ),
                  RichText(
                ...
                text: TextSpan(
                  style: TextStyle(fontFamily: 'Browallia New', fontSize: 12.0),
                  children: [
                    TextSpan(text: 'Any questions, contact customer service at '),
                    TextSpan(text: 'support@mealshift.co.uk', style: const TextStyle(color: Color(0xFF0066CC), decoration: TextDecoration.underline), recognizer: TapGestureRecognizer()..onTap = () { /* mailto:support@mealshift.co.uk */ }),
                    TextSpan(text: '.'),
                  ],
                ),
              ),
