...
Widget _content() => UnconstrainedBox(
  ...
  builder: (context, constraints) {
    ...
    final flexSpace = availableWidth.isInfinite ? 0.0 : (availableWidth - fixedTotal - pctUnit * 100.0).clamp(0.0, double.infinity);
  ...
  builder: (context, constraints) {
    ...
    final rowHeights = <double>[41.0, 41.0, 41.0, 46.0];
  ...
  builder: (context, constraints) {
    ...
    final fixedTotal = 0.0;
    final pctUnit = availableWidth.isInfinite ? 0.0 : availableWidth / 100;
    final flexSpace = availableWidth.isInfinite ? 0.0 : (availableWidth - fixedTotal - pctUnit * 99.0).clamp(0.0, double.infinity);
    final flexUnit = availableWidth.isInfinite ? 200.0 : flexSpace / 0.001000;
    final colWidths = <double>[
      pctUnit * 33.0,
      pctUnit * 33.0,
