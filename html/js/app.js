const App = {
  ...
  _buildMainDartCode() {
    ...
    const lines = [
      ...
      '// Drop main.dart into html_preview/lib/ alongside preview_shell.dart',
    ...
    if (multiPage) {
      // Multi-page: generate _page1(), _page2(), ... and pass as list.
      ...
      if (!needsStateful) {
        ...
        // Stateful + multi-page: _page methods must be instance methods of the state
        // so they can access controllers/state variables.
