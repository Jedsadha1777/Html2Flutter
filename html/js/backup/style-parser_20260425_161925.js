const StyleParser = {
  ...
  expandFont(value) {
    ...
    for (let i = 0; i < parts.length; i++) {
      const part = parts[i];
      const lower = part.toLowerCase();
      if (['bold','bolder','lighter','normal'].includes(lower) || this._isThreeDigits(part)) {
        ...
        // CSS font-size keyword (xx-small/.../xxx-large/smaller/larger) — store as-is.
        result.fontSize = part;
        sawSize = true;
